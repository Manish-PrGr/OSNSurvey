...
var option0 = document.getElementById('alt-opt-0');
...
function prevButtonClicked() {
    if (btnCount > 0) {
        btnCount = btnCount - 1;
        buttonClicked(btnCount);
        document.getElementById(btnCount).style.backgroundColor = '#000';
        document.getElementById(btnCount + 1).style.backgroundColor = '';
    }
    else {
        btnCount = 6;
        buttonClicked(btnCount);
        document.getElementById(btnCount).style.backgroundColor = '#000';
        document.getElementById(btnCount - 6).style.backgroundColor = '';
    }
